...
/** 技能组报表 */
public class ReturnDepartmentReport {
	private String selectDay;		//日期
	private String selectHour;		//时段
	private String departmentCallLoss;
	...
	public String getDepartmentCallLoss() {
		return departmentCallLoss;
	}
	public void setDepartmentCallLoss(String departmentCallLoss) {
		this.departmentCallLoss = departmentCallLoss;
	}
}
