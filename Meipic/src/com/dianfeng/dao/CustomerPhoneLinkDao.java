...
public interface CustomerPhoneLinkDao
{
	/**
	 * 根据客户ID查找客户的手机关联信息
	 ...
	 * 新增的条数
	 */
	int insertCustomerPhoneLink(@Param(value="customerPhoneLinkList")List<CustomerPhoneLink> customerPhoneLinkList);
	 ...
	 * 删除的条数
	 */
	int deleteCustomerPhoneLink(@Param(value="customerPhoneLinkList")List<CustomerPhoneLink> customerPhoneLinkList);
