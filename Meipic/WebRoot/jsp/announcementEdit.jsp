...
<table style="width: 640px;height: 530px" >
	<tr>
		<th colspan="2" style="height: 80px;font-size: 18px">
			<span id="select_title">${announcement.title}</span>
		</th>
	</tr>
	<tr height="30px">
		<th width="15%"></th>
		<th align="center">
			<span id="select_promulgator">${announcement.promulgator}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<span id="select_releaseDate">${announcement.releaseDate}</span>
		</th>
	</tr>
