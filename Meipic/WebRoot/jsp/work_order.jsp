...
//来电号码
String default_tel = request.getAttribute("default_tel").toString();
...
String customer_area = customerInfo==null?"":customerInfo.getArea();
String customer_qq =  customerInfo==null?"":customerInfo.getQq();
String customer_tel1 =  customerInfo==null?default_tel:"";
...
String customer_postal_code =  customerInfo==null?"":customerInfo.getPostalCode();
...
String customer_agent =  customerInfo==null?"":customerInfo.getAgent();
...
<html>
  ...
  <body>
  	<%-- 绑定客户的弹出层 --%>
	<div id="select_customer_dialog" class="easyui-dialog" title="绑定客户" style="width:1000px;height:auto;padding:10px">
		<table style="width: 100%" >
			<tr>
				...
				<td width="60px">年龄：</td>
				<td style="width: 180"><input id="customer_age_old" class="easyui-numberbox" style="width: 150px" value=""></input></td>
			</tr>
			<tr>
				...
				<td style="width: 180"><input id="customer_tel_old" class="easyui-numberbox" style="width:150px" value=""></td>
			...
			<tr>
				...
				<td style="width: 180"><input id="customer_qq_old" class="easyui-numberbox" style="width:150px" value=""></input></td>
				...
				<td style="width: 180"><input id="customer_postal_code_old" class="easyui-numberbox" style="width: 150px" value=""></input></td>
			</tr>
			<tr>
		...
		<table id="customer_phone_info_old_table" title="客户详细信息">
			...
			<tr>
				...
				<th data-options="field:'tel',width:80,align:'left'">联系电话</th>
				...
				<th data-options="field:'type',width:80,align:'left'">用户类别</th>
	...
	<%-- 工单跟进的弹出层 --%>
	<div id="follow_work_order_dialog" class="easyui-dialog" title="审核黑名单" data-options="buttons: [{
					text:'确定',
					iconCls:'icon-ok',
					handler:function(){
						saveFollowWorkOrder();
    ...
    <div  class="easyui-panel" title="工单" style="padding: 10px">
	    <div  class="easyui-panel" title="来电信息" style="padding: 10px" data-options="collapsible:true,">
			<table style="width: 100%" >
				<tr>
					<td width="60px">工单流水：</td>
					<td style="width: 180"><input id=work_order_assembly_line class="easyui-numberbox" value="<%=work_order_assembly_line %>" style="width: 150px"></input></td>
					<td width="60px">来电号码：</td>
					<td style="width: 180"><input id="work_order_tel" class="easyui-numberbox" value="<%=default_tel %>" style="width: 150px"></input></td>
					<td width="60px">来电时间：</td>
					<td style="width: 180"><input id="work_order_tel_time" editable="false" class="easyui-datetimebox" value="<%=work_order_tel_time %>" style="width:150px"></input></td>
				</tr>
			</table>
		</div>
		 ...
		 <div  class="easyui-panel" title="客户信息" style="padding: 10px" data-options="collapsible:true,">
			<table style="width: 100%" >
				<tr>
					...
					<td width="60px">年龄：</td>
					<td style="width: 180"><input id="customer_age" class="easyui-numberbox" style="width: 150px" value="<%=customer_age %>" onchange="customerInfoChange()"></input></td>
				</tr>
				<tr>
					<td width="60px">地区/国籍：</td>
					...
					<td style="width: 180"><input id="customer_tel1" class="easyui-numberbox" style="width:150px" value="<%=customer_tel1 %>" onchange="customerInfoChange()"></td>
					<td width="60px">联系电话2：</td>
					<td style="width: 180"><input id="customer_tel2" style="width: 150px" value="<%=customer_tel2 %>"></input></td>
				</tr>
				<tr>
					<td width="60px">QQ号码：</td>
					<td style="width: 180"><input id="customer_qq" class="easyui-numberbox" style="width:150px" value="<%=customer_qq %>" onchange="customerInfoChange()"></input></td>
					<td width="60px">客户地址：</td>
					...
					<td width="60px">邮政编码：</td>
					<td style="width: 180"><input id="customer_postal_code" class="easyui-numberbox" style="width: 150px" value="<%=customer_postal_code %>" onchange="customerInfoChange()"></input></td>
				</tr>
				<tr>
					<td width="60px">微信号：</td>
				...
				<tr>
					...
					<td width="60px">电子邮件：</td>
					<td style="width: 180"><input id="customer_email" class="easyui-textbox" style="width: 150px" value="<%=customer_email %>" onchange="customerInfoChange()"></input></td>
					<td width="60px">京东账号：</td>
			...
			data-options="url:'customer_work_order_link.do?method=findWorkOrderByCustomerId&customerId=<%=customer_id %>'">
				<thead>
					<tr>
						<th data-options="field:'id',width:100,align:'center'">工单ID</th>
			            <th data-options="field:'assemblyLine',align:'left',width:80">工单流水</th>
			            <th data-options="field:'feedbackType',align:'left',width:80">反馈类型</th>
			            <th data-options="field:'title',align:'left',width:80">标题</th>
						<th data-options="field:'tel',align:'left',width:80">来电号码</th>
						<th data-options="field:'telTime',width:100,align:'center'">来电时间</th>
			...
			<table style="width: 100%" >
				<tr>
					...
					<td style="width: 180"><input id="work_order_level" value="" style="width: 150px"></input></td>
				</tr>
				<tr>
					<td width="60px">反馈时间：</td>
					<td style="width: 180"><input id="work_order_feedback_time" editable="false" class="easyui-datetimebox" value="" style="width:150px"></input></td>
					<td width="60px">技能组：</td>
					<td style="width: 180"><input id="work_order_skill_group" editable="false" style="width: 150px"></input></td>
				</tr>
				<tr>
					<td width="60px">反馈类型：</td>
					<td style="width: 180"><input id="work_order_feedback_type" style="width: 150px"></input></td>
					<td width="60px">反馈渠道：</td>
					<td style="width: 180"><input id="work_order_feedback_channel" style="width: 150px"></input></td>
				</tr>
			</table>
			<div style="margin: 10px"></div>
			...
			<table style="width: 100%" >
				...
				<tr>
					...
					<td style="width: 180"><input id="work_order_final_decision" editable="false" value="" style="width:150px"></input></td>
				</tr>
			</table>
			<div style="margin: 10px"></div>
			<table width = "100%">
