  ...
  <body onload="hideOverlay()">
	...
	<div id="add_role_dialog" class="easyui-dialog" title="新建角色" data-options="buttons: [{
		...
		<table>
			...
			<td>
				<input type="checkbox" value="3" name="录音调听"/>录音调听
			</td>
			<td>
				<input type="checkbox" value="4" name="知识库"/>知识库
			</td>
			</tr>
			<tr>
			<td>
				<input type="checkbox" value="5" name="公告栏"/>公告栏
			</td>
			<td>
				<input type="checkbox" value="6" name="座席外呼"/>座席外呼
			</td>
			<td>
				<input type="checkbox" value="7" name="CRM"/>CRM
			</td>
			<td>
				<input type="checkbox" value="8" name="坐席班长"/>坐席班长
			</td>
			</tr>
			<tr>
			<td>
				<input type="checkbox" value="9" name="管理员"/>管理员
			</td>
			<td>
				<input type="checkbox" value="10" name="黑名单"/>黑名单
			</td>
			<td>
				<input type="checkbox" value="11" name="话务报表"/>话务报表
			</td>
			<td>
				<input type="checkbox" value="12" name="假日转接"/>假日转接
			</td>
			</tr>
		</table>
		</div>
    		...
    		<table id="user_table" title="用户列表">
				<thead>
					<tr>
						...
						<th field="name" width="100">用户姓名</th>    
			            <th field="agent" width="100" align="center">座席号</th>
						<th field="roleId" width="100">用户角色</th>    
						<th field="roleDisplay" width="120">用户角色</th>    
			            <th data-options="field:'departmentId',align:'left',width:80">所属部门</th>
			            <th data-options="field:'departmentDisplay',align:'left',width:150">所属部门</th>
						<th data-options="field:'queue',width:100,align:'center'">队列</th>
						<th data-options="field:'area',width:100,align:'left',formatter:function(value,row)
									{if(value.length>0){
